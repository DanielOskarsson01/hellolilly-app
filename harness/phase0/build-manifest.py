...
manifest = {
    ...
    "phase0_decisions": {
        "baseline_confirmed_by": "Daniel",
        "baseline_confirmed_on": RUN_DATE,
        "baseline_confirmation": "The three reference CVs look like the good CVs (0e gate passed).",
        "wave1_model": "claude-sonnet-4-6 (selection/reordering only - Wave 1 does no writing)",
        "writing_wave_model": "claude-opus-4-8 - designated for the NEXT wave (the suggestion engine, D20c), where AI actually drafts content; validated live. Not used this wave.",
        "judgement_calls": "JC1 (cardinality) and JC2 (all-sections-non-empty) adopted as-is, not vetoed.",
        "control_ad": "Ramen Bae stands as the CONTROL (not replaced).",
        "header_image_height": {
            "decision": "HelloLilly renderer uses natural/undistorted heights at width 800; reference oracle frozen.",
            "reference_frozen": {"medium": 280, "large": 400, "small": 160},
            "hellolilly_template": {"medium": 316, "large": 452, "small": 181},
        },
    },
    "run_config": {
